		...
		<div className='profile'>
			{loading ? (
				...
				<div>
					...
					<div className='mt-16 container mx-auto layout-background'>
						<div className='sm:w-8/12 mx-auto w-10/12'>
							<img src={require('../../assets/img/logo-pelindo.png').default} alt='asset' className='sm:w-2/5 w-3/4 my-8' />

							<div className='mt-8 mb-52'>
								<p className='text-md sm:text-1em my-8 leading-loose'>{paragraf1}</p>
								<p className='text-md sm:text-1em my-8 leading-loose'>{paragraf2}</p>

								<div className='font-bold text-md sm:text-1em'>{nameCompany}</div>

								<div className='text-md sm:text-1em mt-8'>
