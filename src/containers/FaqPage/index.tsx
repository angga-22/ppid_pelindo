...
const Index = () => {
  ...
  useEffect(() => {
    FaqApi(($: any) => {
      ...
      $(
        "tbody > tr:nth-child(1), tr:nth-child(2), tr:nth-child(3), tr:nth-child(4), tr:nth-child(5), tr:nth-child(6) > td:nth-child(2)"
      ...
      <div className="container my-8 mx-auto">
        <div className="px-2 sm:px-0">
          <div className="border rounded-lg p-4 flex flex-col justify-between  my-4 border-gray-200 px-2 ">
            {qa.map((list: any) => (
              <div className="text-lg my-2 sm:my-0">{list.title} </div>
            ))}
          </div>
        </div>
      </div>
